...
const InventoryExitPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (parseInt(form.cantidad) > producto.stock) {
      setAlert({
        type: "error",
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className={`font-bold text-lg ${stockColorClass}`}>
                ...
                <div className="mt-4 flex items-center gap-2 bg-orange-50 border border-orange-200 rounded-lg p-3">
                  ...
                  <p className="text-sm text-orange-800 font-medium">
                    {producto.stock === 0
                      ...
                      : "⚠️ Stock bajo - Quedan pocas unidades"}
                  </p>
                </div>
              )}
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full border border-gray-300 rounded-lg px-4 py-3 text-lg font-semibold focus:border-red-500 focus:ring-2 focus:ring-red-200 transition-colors disabled:bg-gray-100 disabled:cursor-not-allowed"
                  placeholder={
                    producto.stock === 0
                      ? "Sin stock"
              ...
              <div>
                ...
                <select
                  ...
                  required
                  disabled={producto.stock === 0}
                  className="w-full border border-gray-300 rounded-lg px-4 py-3 focus:border-red-500 focus:ring-2 focus:ring-red-200 transition-colors disabled:bg-gray-100 disabled:cursor-not-allowed"
                >
              ...
              <div>
                ...
                <input
                  ...
                  disabled={producto.stock === 0}
                  className="w-full border border-gray-300 rounded-lg px-4 py-3 focus:border-red-500 focus:ring-2 focus:ring-red-200 transition-colors disabled:bg-gray-100 disabled:cursor-not-allowed"
                  placeholder="Nombre del cliente o destino (opcional)"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows="4"
                  disabled={producto.stock === 0}
                  className="w-full border border-gray-300 rounded-lg px-4 py-3 focus:border-red-500 focus:ring-2 focus:ring-red-200 transition-colors resize-none disabled:bg-gray-100 disabled:cursor-not-allowed"
                  placeholder="Notas adicionales sobre esta salida (opcional)"
                />
              </div>
              ...
              <div className="flex justify-end gap-3 pt-6 border-t border-gray-200">
                ...
                <button
                  type="submit"
                  disabled={saving || producto.stock === 0}
                  className="flex items-center gap-2 bg-red-600 hover:bg-red-700 text-white font-medium px-6 py-3 rounded-lg shadow-sm disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2"
                >
                  <Save size={20} />
